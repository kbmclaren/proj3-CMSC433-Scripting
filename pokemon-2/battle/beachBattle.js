...
console.log(jsonData.wallet.pokeballs);
console.log(jsonData.pokedex);
...
// Enemy Team Pokemon
const enemy1 = new Pokemon("Tentacruel", 80, 80, 82, 85);
...
// Enemy team sprites
var right1 = new Sprite('pokemonImg/073Tentacruel.png', "right", 600, 600, 200, 200, 1200, 450, 1200, 450, 'scratch.wav');
...
function viewBag(){
	...
	button2.innerHTML = "Pokeballs: (" + pokeballCount + ")";
	button4.innerHTML = " ";
	button5.innerHTML = " ";
	button6.innerHTML = " ";
