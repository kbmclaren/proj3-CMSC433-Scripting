...
const player1 = new Pokemon("Squirtle", 200, 200, 100, 60);
...
// Enemy Team Pokemon- Cerulean Gym
const enemy1 = new Pokemon("Golduck", 80, 80, 82, 85);
const enemy2 = new Pokemon("Slowbro", 95, 95, 75, 30);
const enemy3 = new Pokemon("Lapras", 130, 130, 85, 60);
const enemy4 = new Pokemon("Starmie", 60, 60, 75, 115);
var enemyArray = [enemy1, enemy2, enemy3, enemy4];
var enemyTeam = new Team(4, enemyArray);
var enemy = enemy1;
var curEnemy = 0;


// Enemy team sprites
var right1 = new Sprite('pokemonImg/055Golduck.png', "right", 600, 600, 200, 200, 1200, 450, 1200, 450, 'scratch.wav');
var right2 = new Sprite('pokemonImg/080Slowbro.png', "right", 600, 600, 200, 200, 1200, 450, 1200, 450, 'scratch.wav');
var right3 = new Sprite('pokemonImg/131Lapras.png', "right", 600, 600, 200, 200, 1200, 450, 1200, 450, 'scratch.wav');
var right4 = new Sprite('pokemonImg/121Starmie.png', "right", 600, 600, 200, 200, 1200, 450, 1200, 450, 'scratch.wav');
var enemySprites = [right1, right2, right3, right4];
...
onload = function() {
	promptText.innerHTML="Ready to Battle Gym Leader " + bossName + "?";
...
function gameLoop(){
	...
	// Main set of prompts
	promptText.innerHTML="What will you do?";
...
function viewBag(){
	...
	button2.innerHTML = "Don't use item (Go back)";
	button3.innerHTML = " ";
	button4.innerHTML = " ";
	button5.innerHTML = " ";
	button6.innerHTML = " ";
	...
	button1.onclick = function(){sureUseItem();}
	button2.onclick = function(){gameLoop();}
}
...
function endGame(){
	...
	if(playerTeam.numLeft == 0){
		...
		promptText.innerHTML = "You beat Gym Leader" + bossName + "!";
	}
...
function enemyFaints(){
	...
	setTimeout(function() {
		if(enemyTeam.numLeft > 1){
			...
			updateRightHealth();
			enemyTeam.numLeft -= 1;
			promptText.innerHTML= bossName + " sent out " + enemy.name;
			gameLoop();
		}
		else {
			endGame();
