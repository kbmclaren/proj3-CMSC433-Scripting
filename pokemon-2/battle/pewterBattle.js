...
const player2 = new Pokemon("Vileplume", 200, 200, 50, 60);
var playerArray = [player1, player2];
var playerTeam = new Team(2, playerArray);
...
var left2 = new Sprite('045Vileplume_reversed.png', "left", 600, 600, 200, 200, 400, 450, 400, 450, 'cut.wav');
var playerSprites = [left1, left2];
var leftMon = playerSprites[0];

// Enemy Team Pokemon- Pewter Gym
const enemy1 = new Pokemon("Diglett", 10, 10, 55, 95);
const enemy2 = new Pokemon("Sandshrew", 60, 60, 75, 40);
var enemyArray = [enemy1, enemy2];
var enemyTeam = new Team(2, enemyArray);
var enemy = enemy1;
var curEnemy = 0;

// Enemy team sprites
var right1 = new Sprite('pokemonImg/050Diglett.png', "right", 600, 600, 200, 200, 1200, 450, 1200, 450, 'scratch.wav');
var right2 = new Sprite('pokemonImg/027Sandshrew.png', "right", 600, 600, 200, 200, 1200, 450, 1200, 450, 'scratch.wav');
var enemySprites = [right1, right2];
...
function endGame(){
	...
	// just make all the buttons leave
