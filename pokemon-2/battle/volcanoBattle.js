...
const player1 = new Pokemon("Squirtle1", 200, 200, 100, 60);
const player2 = new Pokemon("Squirtle2", 200, 200, 100, 60);
const player3 = new Pokemon("Squirtle3", 500, 500, 100, 60);
const player4 = new Pokemon("Squirtle4", 100, 100, 100, 60);
const player5 = new Pokemon("Squirtle5", 100, 100, 100, 60);
const player6 = new Pokemon("Squirtle6", 100, 100, 100, 60);
var playerArray = [player1, player2, player3, player4, player5, player6];
var playerTeam = new Team(6, playerArray);
...
var left2 = new Sprite('007squirtle.png', "left", 600, 600, 200, 200, 400, 450, 400, 450, 'cut.wav');
var left3 = new Sprite('007squirtle_reversed.png', "left", 600, 600, 200, 200, 400, 450, 400, 450, 'cut.wav');
var left4 = new Sprite('007squirtle_reversed.png', "left", 600, 600, 200, 200, 400, 450, 400, 450, 'cut.wav');
var left5 = new Sprite('007squirtle_reversed.png', "left", 600, 600, 200, 200, 400, 450, 400, 450, 'cut.wav');
var left6 = new Sprite('007squirtle_reversed.png', "left", 600, 600, 200, 200, 400, 450, 400, 450, 'cut.wav');
var playerSprites = [left1, left2, left3, left4, left5, left6];
var leftMon = playerSprites[0];

// Enemy Team Pokemon
const enemy1 = new Pokemon("Magmar", 80, 80, 82, 85);
...
// Enemy team sprites
var right1 = new Sprite('pokemonImg/126Magmar.png', "right", 600, 600, 200, 200, 1200, 450, 1200, 450, 'scratch.wav');
...
function viewBag(){
	...
	button1.innerHTML = "Potions: (" + /*numPotions +*/ ")";
